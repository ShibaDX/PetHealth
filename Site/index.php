...
<head>
  ...
  <title>Clínica Veterinária São Francisco de Assis</title>
...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope"></i> <a href="mailto:contact@example.com">contato@clinicaveterinariasfa.com</a>
        <i class="bi bi-phone"></i> (00) 0000-0000
      </div>
    </div>
  </div>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      ...
      <h2>Cuidando com amor e dedicação dos seus amigos de quatro patas.</h2>
    </div>
  </section><!-- End Hero -->
