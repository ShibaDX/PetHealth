...
//Exclusão
if (isset($_GET['id'])) {
    $sql = "delete from raca where id = " . $_GET['id'];
                        ...
                        <?php while ($linha = mysqli_fetch_array($resultado)) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="listagemRaca.php?id=<?= $linha['id'] ?>" class="btn btn-danger" onclick="return confirm('Confirma exclusão?')"><i class="fa-solid fa-trash" style="color: #000000;"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
