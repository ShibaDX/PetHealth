            ...
            <div id="content">
                ...
                <div class="container-fluid">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-1">
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <button type="submit" class="btn btn-success" name="statusAgenda" value="Concluido">Concluído</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    if (isset($_POST['salvar'])) {
                        ...
                        $consulta_disponibilidade = "SELECT * FROM agenda WHERE data = '$data' AND hora = '$hora' AND veterinario_id = '$veterinario_id' AND id != '$id' ";
                        ...
                        if (mysqli_num_rows($resultado_disponibilidade) > 0) {
                            ...
                            //3. Preparar a SQL
                            $sql = "update agenda set data = '$data', hora = '$hora', statusAgenda = '$status', obs = '$obs', procedimento_id = '$procedimento_id', veterinario_id = '$veterinario_id' where id = '$id'";
