<?php
        ...
        if (isset($_POST['salvar'])) {
            ...
            //3. Preparar a SQL
        $sql = "update veterinario set nome = '$nome', telefone = '$telefone', dataNascimento = '$dataNascimento', email = '$email', senha = '$senha', CRMV = '$crmv' where id = $id";
    ...
    <?php require_once("topbarAdmin.php"); ?>
        ...
        <input type="hidden" name="id" value="<?= $linha['id']?>">
            ...
            <div class="mb-1">
                ...
                <input name="crmv" type="password" class="form-control" value="<?=$linha['CRMV'] ?>"><br>
