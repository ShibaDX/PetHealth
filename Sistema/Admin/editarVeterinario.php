        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                        ...
                        <form method="post">
                            ...
                            <div class="row">
                                ...
                                <label for="sexo" class="form-label">Sexo</label>
                                    <select id="sexo" name="sexo" class="form-control" value="<?= $linha['sexo'] ?>">
                                        <?php
                                ...
                                <div class="col-4">
                                    <div class="mb-1">
                                        ...
                                        <input name="senha" id="senha" type="password" class="form-control"
                                            value="<?= $linha['senha'] ?>">
                                        <input type="checkbox" onclick="togglePassword()"> <i class="fa-solid fa-eye"
                                            style="color: #000000;"></i> Mostrar Senha<br>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="mb-1">
                ...
                if (isset($_POST['salvar'])) {
                    ...
                    //3. Preparar a SQL
                    $sql = "update veterinario set nome = '$nome', telefone = '$telefone', sexo = '$sexo', dataNascimento = '$dataNascimento', email = '$email', senha = '$senha' , CRMV = '$crmv' where id = $id";
