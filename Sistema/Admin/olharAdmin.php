                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="mb-1">
                                        ...
                                        <input disabled name="telefone" type="text" maxlength="15" class="form-control" onkeyup="handlePhone(event)" value="<?= $linha['telefone'] ?>"><br>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="mb-1">
                                ...
                                <div class="col-4">
                                    <div class="mb-1">
                                        ...
                                        <input disabled name="cpf" type="text" class="form-control" maxlength="15" value="<?= $linha['cpf'] ?>" oninput="applyCpfMask(this)"><br>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="mb-1">
                                        <div class="mb-1">
                                            <label for="formGroupExampleInput" class="form-label">Data de Admissão</label>
                                            <input disabled name="dataAdmissao" id="dataAdmissao" type="date" class="form-control" value="<?= $linha['dataAdmissao'] ?>">
                                ...
                                <div class="col-4">
                                    <div class="mb-1">
                                        <div class="mb-1">
                                            ...
                                            <input disabled name="dataDemissao" id="dataDemissao" type="date" class="form-control" value="<?= $linha['dataDemissao'] ?>">
                                            <!-- Adicione um campo oculto para enviar um valor especial quando o botão "Limpar" for clicado -->
                                            <input type="hidden" name="limparDataDemissao" id="limparDataDemissao" value="0">
                                        </div>
                                    </div>
