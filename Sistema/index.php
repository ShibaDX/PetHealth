...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="login/images/icons/favicon1.png"/>
<!--===============================================================================================-->
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('login/images/bg-01.png');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54" style="border: 1px ridge grey">
				<form class="login100-form validate-form" action="autenticacao.php" method="post">
					...
					<div class="wrap-input100 validate-input m-b-23" >
						...
						<input class="input100" type="text" name="email" id="email" placeholder="Digite o e-mail">
